...
export function HeroSection() {
  return (
    <>
      ...
      `}</style>
      <section className="hero-section relative overflow-hidden pt-24 pb-20 md:pt-32 md:pb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                <Link href="https://teams.microsoft.com" className="hero-cta-secondary inline-flex items-center justify-center gap-2 font-bold rounded px-6 py-3" target="_blank" rel="noopener noreferrer">
                  Chat on Teams
                </Link>
              </div>
